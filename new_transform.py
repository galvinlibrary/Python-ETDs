...
home = "C:\\Users\\tfluhr\\Documents\\islandora_cleanup\\DspaceUnproccessed\\etds_unzipped"

## xsl definitions

proquest_xsl = "C:\\Users\\tfluhr\\Documents\\islandora_cleanup\\greer\\fixsubject_etd_proquest.xsl"
dc_xsl = "C:\\Users\\tfluhr\\Documents\\islandora_cleanup\\greer\\dc_to_mods_etd.xsl"
iit_xsl = "C:\\Users\\tfluhr\\Documents\\islandora_cleanup\\greer\\mods_iitmetadata_combine.xsl"
no_proquest_xml = "C:\\Users\\tfluhr\\Documents\\islandora_cleanup\\greer\\fixsubject_etd_noproquest.xsl"
...
for d in subs_list:
    ...
    if os.path.isfile(pq_found):
        ...
        local_pq_xsl = shutil.copy(no_proquest_xml, d)
        new_dc = d + "\\dublin_core.xml"
        #print("proquest file found")
        xml_input = lxml.etree.parse(d + "\\dublin_core.xml")
        xslt_root = lxml.etree.parse(local_pq_xsl)
